...
public class SeekBarControl
{
	...
	public void setOnSeekBarControlPositionChangeListener(OnSeekBarControlPositionChangeListener onSeekBarControlPositionChangeListener)
	{
	...
	private OnSeekBarChangeListener onSeekBarChangeListener = new OnSeekBarChangeListener()
	{
		...
		public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser)
		{
			...
			{
				onSeekBarControlPositionChangeListener.onSeekBarControlPositionChange(view.getId(), progress + min, min, max);
			}
		}
	};
}
